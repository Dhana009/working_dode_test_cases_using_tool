...
#pytest test_must_parse_post_all_jds_pdfs.py -k "test_login or test_post_new_job_must_parse_TC011_invisible_text" --html=report.html
...
class TestLoginAndPost:
    ...
    def test_post_new_job_must_parse_TC008_complex_document_structure(self, driver_setup):
        ...
        folder_path_for_must_parse_case = readconfig_file("jds_location", 'pdf_tc008')
    ...
    def test_post_new_job_must_parse_TC009_Unexpected_Page_Breaks(self, driver_setup):
        ...
        folder_path_for_must_parse_case = readconfig_file("jds_location", 'pdf_tc009')
    ...
    def test_post_new_job_must_parse_TC010_extreme_test_density(self, driver_setup):
        ...
        folder_path_for_must_parse_case = readconfig_file("jds_location", 'pdf_tc010')
    ...
    def test_post_new_job_must_parse_TC011_invisible_text(self, driver_setup):
        ...
        folder_path_for_must_parse_case = readconfig_file("jds_location", 'pdf_tc011')
    ...
    def test_post_new_job_must_parse_TC012_very_small_font_sizes(self, driver_setup):
        ...
        folder_path_for_must_parse_case = readconfig_file("jds_location", 'pdf_tc012')
    ...
    def test_post_new_job_must_parse_TC013_complex_tables(self, driver_setup):
        ...
        folder_path_for_must_parse_case = readconfig_file("jds_location", 'pdf_tc013')
    ...
    def test_post_new_job_must_parse_TC014_with_watermarks(self, driver_setup):
        ...
        folder_path_for_must_parse_case = readconfig_file("jds_location", 'pdf_tc014')
