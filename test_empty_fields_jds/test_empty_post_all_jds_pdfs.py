...
#pytest test_empty_post_all_jds_pdfs.py -k "test_login or test_post_new_job_TC004_image_only_content" --html=report.html
...
class TestLoginAndEmptyPost:
    ...
    def test_post_new_job_TC001_empty_file(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'pdf_tc001')
    ...
    def test_post_new_job_TC004_image_only_content(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'pdf_tc004')
    ...
    def test_post_new_job_TC005_unicode_characters(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'pdf_tc005')
    ...
    def test_post_new_job_TC006_embedded_images(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'pdf_tc006')
    ...
    def test_post_new_job_TC007_ascii_characters(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'pdf_tc007')
