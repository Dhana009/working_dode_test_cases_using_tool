...
#pytest test_empty_post_all_jds_docx.py -k "test_login or test_post_new_job_TC006_embedded_images" --html=report.html
...
class TestLoginAndEmptyPost:
    ...
    def test_post_new_job_TC001_empty_file(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'docx_tc001')
    ...
    def test_post_new_job_TC004_image_only_content(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'docx_tc004')
    ...
    def test_post_new_job_TC005_unicode_characters(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'docx_tc005')
    ...
    def test_post_new_job_TC006_embedded_images(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'docx_tc006')
    ...
    def test_post_new_job_TC007_ascii_characters(self, driver_setup):
        ...
        folder_path_for_empty_case_docx = readconfig_file("jds_location", 'docx_tc007')
